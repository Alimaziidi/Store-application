...
import com.example.shoppingapp.activity.adapter.CommentLimitAdapter;
import com.example.shoppingapp.activity.adapter.ImageProductAdapter;
import com.example.shoppingapp.activity.adapter.OptionProductAdapter;
import com.example.shoppingapp.activity.adapter.SimilarProductAdapter;
...
import com.example.shoppingapp.activity.model.Comment;
import com.example.shoppingapp.activity.model.ImageProduct;
import com.example.shoppingapp.activity.model.OptionProduct;
...
public class ShowDetailProductActivity extends AppCompatActivity {
    ...
    static String id , name_product , name_brand , category_id , value_off , price , price_off , link_img , user_email,amount;
    Bundle bundle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // elegunt = findViewById(R.id.elegunt);
        ...
        if (price_off==null || value_off=="0" || price.equals(price_off)){
            txt_value_off.setVisibility(View.GONE);
            txt_price_off.setVisibility(View.GONE);
        ...
        btn_send_to_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ("0".equals(amount)) {
                    ...
                    Toast.makeText(ShowDetailProductActivity.this, "کالا در انبار وجود نمی باشد!", Toast.LENGTH_SHORT).show();
                    ...
                    Intent intent = new Intent(ShowDetailProductActivity.this , CartActivity.class);
                    intent.putExtra(Key.id , id);

...
import com.example.shoppingapp.activity.adapter.DetailCategoryAdapter;
import com.example.shoppingapp.activity.adapter.DetailNewProductAdapter;
import com.example.shoppingapp.activity.adapter.DetailProductPopularAdapter;
import com.example.shoppingapp.activity.model.Amazing;
import com.example.shoppingapp.activity.model.AmazingOfferProduct;
import com.example.shoppingapp.activity.model.DetailCategory;
...
public class DetailCategoryActivity extends AppCompatActivity {
    ...
    private void getDetailNewProduct(String id) {
        ...
        FirstAmazing firstAmazing = new FirstAmazing("به روز ترین محصولات در حوزه کالای دیجیتال در اختیار شماست",
                "https://www.digikala.com/mag/wp-content/uploads/2018/09/amazing-offer.jpg");;

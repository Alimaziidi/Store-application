...
public class NewProductAdapter extends RecyclerView.Adapter<NewProductAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.txt_amount.setText(" موجودیت کالا : " + data.get(position).getAmount());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(Key.amount , clickedProduct.getAmount());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView txt_name_product , txt_price,txt_amount;
